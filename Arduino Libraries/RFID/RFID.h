...
#define PCD_RESETPHASE        0x0F               //复位 00001111
...
//------------------MFRC522寄存器---------------
//Page 0:Command and Status  命令与状态寄存器
#define     Reserved00            0x00    
#define     CommandReg            0x01  //最重要的寄存器  启动和停止命令的执行  
...
#define     TModeReg              0x2A //定义内部计时器的设置
#define     TPrescalerReg         0x2B //定义内部计时器的设置
