...
#define GET_CMD_PACKET(...) \
  ...
  DYE_Fingerprint_Packet packet(FINGERPRINT_COMMANDPACKET, sizeof(data), data); \
...
*/
/**************************************************************************/
DYE_Fingerprint::DYE_Fingerprint(SoftwareSerial *ss, uint32_t password) {
...
*/
/**************************************************************************/
DYE_Fingerprint::DYE_Fingerprint(HardwareSerial *hs, uint32_t password) {
  thePassword = password;
  theAddress = 0xFFFFFFFF;
...
*/
/**************************************************************************/
void DYE_Fingerprint::begin(uint32_t baudrate) {
...
*/
/**************************************************************************/
boolean DYE_Fingerprint::verifyPassword(void) {
  return checkPassword() == FINGERPRINT_OK;
}

uint8_t DYE_Fingerprint::checkPassword(void) {
...
*/
/**************************************************************************/
uint8_t DYE_Fingerprint::getImage(void) {
...
*/
uint8_t DYE_Fingerprint::image2Tz(uint8_t slot) {
...
*/
uint8_t DYE_Fingerprint::createModel(void) {
...
/*!
    ...
    @returns <code>FINGERPRINT_PACKETRECIEVEERR</code> on communication error
*/
uint8_t DYE_Fingerprint::storeModel(uint16_t location) {
...
/*!
    ...
    @returns <code>FINGERPRINT_PACKETRECIEVEERR</code> on communication error
*/
uint8_t DYE_Fingerprint::loadModel(uint16_t location) {
...
/*!
    ...
    @returns <code>FINGERPRINT_PACKETRECIEVEERR</code> on communication error
*/
uint8_t DYE_Fingerprint::getModel(void) {
...
/*!
    ...
    @returns <code>FINGERPRINT_PACKETRECIEVEERR</code> on communication error
*/
uint8_t DYE_Fingerprint::deleteModel(uint16_t location) {
...
/*!
    ...
    @returns <code>FINGERPRINT_PACKETRECIEVEERR</code> on communication error
*/
uint8_t DYE_Fingerprint::emptyDatabase(void) {
...
*/
/**************************************************************************/
uint8_t DYE_Fingerprint::fingerFastSearch(void) {
...
*/
/**************************************************************************/
uint8_t DYE_Fingerprint::getTemplateCount(void) {
...
*/
/**************************************************************************/
uint8_t DYE_Fingerprint::setPassword(uint32_t password) {
...
void DYE_Fingerprint::writeStructuredPacket(const DYE_Fingerprint_Packet & packet) {
...
*/
/**************************************************************************/
uint8_t DYE_Fingerprint::getStructuredPacket(DYE_Fingerprint_Packet * packet, uint16_t timeout) {
  uint8_t byte;
